...
export const metadata = {
  ...
  description:
    "Explore Mohiniraj's philosophy, story, mission, and approach to subconscious emotional transformation.",
};
...
export default function JourneyPage() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // 1. Subtle Parallax for Philosophy Section Text & Image
      gsap.fromTo(
  ...
  return (
    ...
    >
      {/* Background Lighting Ambient Mesh (Apple Aesthetic) */}
