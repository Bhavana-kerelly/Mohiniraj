...
export default function TransformationsPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(400px,0.72fr)] lg:gap-16 xl:grid-cols-[minmax(0,1fr)_minmax(500px,0.72fr)] xl:gap-20">
          <div ref={heroContentRef} className="relative min-w-0">
            <div className="relative z-10 max-w-[760px]">
              ...
              <div className="overflow-hidden w-full">
                <h1
                  ref={heroTitleRef}
                  className="font-editorial font-light leading-[0.88] tracking-[-0.045em] text-brand-charcoal w-full"
                >
                  <span className="hero-title-line block whitespace-nowrap text-[clamp(3.5rem,5.8vw,6.8rem)]">
                    TRANSFORMATION
                  </span>
                  <span className="hero-title-line mt-2 block whitespace-nowrap pl-[0.03em] text-[clamp(3.25rem,5.25vw,6.25rem)] italic text-brand-champagne sm:mt-3">
                    ARCHIVE.
                  </span>
                </h1>
              </div>
