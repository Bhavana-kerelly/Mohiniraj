...
export default function TransformationsPage() {
  ...
  return (
    <main
      ref={containerRef}
      className="relative w-full bg-brand-bg text-brand-charcoal min-h-screen pt-24 sm:pt-32 overflow-x-hidden antialiased selection:bg-brand-champagne selection:text-white"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        <InnerPageHero
          ...
          imageSrc="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=1200&auto=format&fit=crop"
