...
export default function ExperiencesMotion() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap
        .utils
        .toArray<HTMLElement>("[data-section-intro]")
        .forEach((section) => {
          const eyebrow =
            section.querySelector("[data-eyebrow]");
          ...
          const rule =
            section.querySelector("[data-section-rule]");
      ...
      >
        <div
          className="
            ...
            items-center
            gap-12
            lg:grid-cols-[minmax(0,1fr)_minmax(390px,0.72fr)]
            lg:gap-16
            xl:grid-cols-[minmax(0,1fr)_minmax(500px,0.72fr)]
            xl:gap-24
          "
        >
          {/* =================================================
          ...
          >
              ...
              >
                <span
                  ...
                  className="
                    block
                    whitespace-nowrap
                    text-[clamp(3.25rem,5.7vw,6.7rem)]
                  "
                >
                  TRANSFORMATION
                </span>
            ...
            <p
              ...
              "
            >
              Choose the depth of engagement designed to
              align with your personal evolution.
            </p>
          </div>
          ...
          >
            ...
            >
              <video
                ...
                "
                aria-label="Transformation experiences"
              />
              ...
              <div
                className="
                  ...
                  absolute
                  inset-0
                  shadow-[inset_0_0_100px_rgba(0,0,0,0.15)]
                "
              />
            </div>
          </div>
          ...
          {DETAILED_EXPERIENCES.map((exp, idx) => {
            ...
            return (
              <article
                ...
                ref={(node) => {
                  if (node) {
                    experienceRefs.current[idx] = node;
                  }
                }}
                className="
                  group
                  ...
                  bg-white/35
                  p-6
                  shadow-[0_24px_80px_rgba(43,37,31,0.06)]
                  sm:p-10
                  lg:p-12
                "
                style={{
